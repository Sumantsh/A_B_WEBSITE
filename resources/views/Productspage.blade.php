...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/static/css/swiperstyle.css">
...
<body>
  <header>
    <div id="topsec">
        ...
        <div class="third">
            <img src="./static/img/visa.png" width="38%" alt="">
            <div id="cart">
                <a href="">view plus</a>
    ...
    <nav id="nav2">
      <div class="navlink2">
        ...
        <a href="delivery.html">Contact us</a>
    ...
    <section id="section">
      ...
      <div id="productdevider">
        ...
        <div id="productinfo">
          ...
          <h2 style="font-size: 24px; font-weight: 600; font-family: robotsan; letter-spacing: 1px; color:#333;">Levitra</h2>
          <i class="fa-solid fa-chevron-right"></i>
          </div>

          <div class="price">
            <p style="font-size: 30px; font-family: open; font-weight: 600;  margin: 4% 0px; color:#57bf6d; ">$ <span id="productpricein">59.80</span>  – $ <span id="productpricein"> 425.40 </span></p>
            <p style="font-size: 14px ;  font-family: robotsan; color: #5f5f5f; margin-bottom: 4%;">Levitra is a therapy for erectile dysfunction treatment.</p>
          </div>
      ...
      <div id="cartwindow">
        <div class="innerwindow">
          ...
          <div class="icon" style="position: relative;"><span><img src="/static/img/icon/bag.svg" width="30px" style="position: relative;" alt=""> <span  style="position: absolute; right: 8%; top: 27%; ">1</span> </span></div>
        ...
        <div id="productvalues">
          ...
          <div class="numberofitems" >
            <p style="font-family: robotsan; ">Levitra - <span id="mumberofpills">30 <span>pills,</span><br> <span id="pillsmg">20 <span>mg</span></span> </span> </p>
            <p ><span id="itemsvalues">1</span> <span>X</span> <span>$ <span id="productprice">59.80</span> <span>=</span> <span>$</span> <span id="totalprice">59.80</span>  </span></p>
          </div>
        ...
        <div id="checkout">
          <div class="subtotal"> Subtotal: <span style="margin-left: 0%; color: #57BF6D;">$</span> <span style="margin-left: -5px; color: #57BF6D;">86.88</span> </div>
      ...
      <div id="carticon2" >
        ...
        <div style="position: absolute; background: black; border-radius: 50%; padding: 5px 10px; color: white; text-align: center; top: -12px; left: -7px; box-shadow: 2px 2px 4px rgba(0, 0, 0,.4) ; ">1</div>
      </div>
    ...
    <footer>
      ...
      <div id="flogo">
        <a href="index.html">
          <img src="./static/img/cropped-EDLifecare-logo.png" class="flogo" alt="logo">
        </a>
      </div>
...
<script src="/static/js/swiperscript.js"></script>
<script src="/static/js/cartwindow.js"></script>
