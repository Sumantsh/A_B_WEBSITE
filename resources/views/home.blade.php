         ...
         <div id="productwrapper" >
           ...
           <div id="leftsideoffer" >
             ...
             <form  style="margin-top: 4%;">
                 ...
                 <input type="text" name="Username" style="width: 95%; height: 40px; border: none; outline: 1px solid black; margin-bottom: 3%;">
                 </div>
                 ...
                 <input type="password" name="password" style="width: 95%; height: 40px; border: none; outline: 1px solid black;margin-bottom: 3%;">
                 </div>

                 <div>
                   <input type="checkbox" name="Remember" id="Remember"> <span style="font-size: 12px;">Remember Me</span> 
                 </div>
                 
                 <div>
                   <button type="submit" style="border: none; background: #0042AF; margin-top: 2%; text-transform: uppercase; font-size: 12px; font-weight: 600; padding: 8px 12px; width: 25%; color: white;">Log in</button>
                 </div>

                 <div>
                   <a href="#" id="lost" style="color:rgba(0 0 0 /.7); font-size: 12px;">Lost your password?<a><a href="" style="display: inline;">|Register</a>
                 </div>
